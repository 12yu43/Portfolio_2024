    ...
    <footer className='footer__main-container'>
      <div className='footer__content-container'>
        <div className='footer__social-container'>
          <ul className='footer__social-links'>
            <SocialMediaLink
              url='https://www.instagram.com/disu_awasthi/'
              icon='fab fa-instagram fa-2x'
            />

            <SocialMediaLink
              url='https://github.com/12yu43'
              icon='fab fa-github fa-2x'
            />

            <SocialMediaLink
              url='https://www.linkedin.com/in/deeksha-awasthi-4b6433203'
      ...
      <div className='footer__message-container'>
        <p className='footer__message'>
          Made with <span style={{ color: 'red' }}>❤</span> by Deeksha Awasthi -{' '}
